...
export const HTTP_PATHS = {
  ...
  UPLOAD_ABORT: "/v1/upload/abort",
  UPLOAD_MULTIPART_PART_URL: "/v1/upload/multipart/part-url",
  UPLOAD_MULTIPART_INITIATE: "/v1/upload/multipart/initiate",
  UPLOAD_MULTIPART_COMPLETE: "/v1/upload/multipart/complete",
  UPLOAD_MULTIPART_ABORT: "/v1/upload/multipart/abort",
  GET_FILE: "/v1/files/{id}",
  DELETE_FILE: "/v1/files/{id}",
  DOWNLOAD: "/v1/files/{id}/download",
  SIGNED_URL: "/v1/files/{id}/signed-url",
  METADATA: "/v1/files/{id}/metadata",
  PROCESSOR_RESULTS: "/v1/files/{id}/processor-results",
  PROCESSOR_RESULT: "/v1/files/{id}/processor-results/{processorKey}",
  VARIANTS: "/v1/files/{id}/variants",
  HEALTH: "/health",
} as const;
export const TOPICS = {
