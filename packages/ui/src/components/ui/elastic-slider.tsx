    ...
    >
      <motion.div
        ...
        className={cn(
          ...
          "data-[focus-visible=true]:ring-2 border data-[focus-visible=true]:ring-ring/50 data-[focus-visible=true]:ring-offset-1 data-[focus-visible=true]:ring-offset-background",
        )}
        ...
        >
          {Array.from({ length: hashMarkCount }, (_, i) => (
            <div
              key={i}
              className={cn(
                "absolute top-1/2 h-2 w-px -translate-x-1/2 -translate-y-1/2 rounded-full transition-all duration-200",
                "bg-transparent bg-(--elastic-slider-hash)",
              )}
