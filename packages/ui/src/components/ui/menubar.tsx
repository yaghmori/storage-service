    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground transition-[opacity,scale,transform,translate] duration-150 ease-out data-[ending-style]:opacity-0 data-[ending-style]:scale-95 data-[starting-style]:opacity-0 data-[starting-style]:scale-95 z-50 min-w-[12rem] origin-[var(--transform-origin)] overflow-hidden rounded-md border p-1 shadow-md",
            className
          )}
          {...props}
        />
...
// NOTE: Base UI's `Menu.GroupLabel` requires a `Menu.Group` parent. Render a
// styled `<div>` so this label is safe to use standalone.
