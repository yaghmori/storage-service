  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-background dark:data-[unchecked]:bg-foreground dark:data-[checked]:bg-primary-foreground pointer-events-none block size-4 rounded-full ring-0 transition-[transform,translate] data-[checked]:translate-x-[calc(100%-2px)] data-[unchecked]:translate-x-0"
        )}
      />
    </SwitchPrimitive.Root>
  );
